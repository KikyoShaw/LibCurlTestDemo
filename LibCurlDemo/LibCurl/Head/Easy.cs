...
namespace LibCurlDemo.LibCurl.Head
{
	...
	public class Easy : IDisposable
	{
        ...
        /// if <see cref="NullReferenceException"/> hasn't bee properly initialized.</exception>
        /// <exception cref="System">This is thrown if
        ...
        // called by libcurlshim
        private static CURLIOERR IoctlDelegate(CURLIOCMD cmd, IntPtr parm)
        {
            GCHandle gch = (GCHandle)parm;
            Easy easy = (Easy)gch.Target;
